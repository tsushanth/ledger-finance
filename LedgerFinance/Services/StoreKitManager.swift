...
enum LedgerProductID: String, CaseIterable {
    case monthly = "com.appfactory.ledgerfinance.subscription.monthly"
    case yearly = "com.appfactory.ledgerfinance.subscription.yearly"
    case lifetime = "com.appfactory.ledgerfinance.lifetime"
    ...
    static var subscriptionIDs: [String] {
        [monthly.rawValue, yearly.rawValue]
    }
...
final class StoreKitManager {
    ...
    func loadProducts() async {
        ...
        do {
            let storeProducts = try await Product.products(for: LedgerProductID.allIDs)
            var subs: [Product] = []
            var nonCons: [Product] = []
    ...
    func product(for id: LedgerProductID) -> Product? {
